const portfolio = [
    ...
    {
        'title': 'Travel Guru',
        'img': 'https://i.postimg.cc/7Y8zVbrX/travel-guru.jpg',
        'description': ' A hotel booking website for travellers. users can choose a place. Getting hotels for booking by providing dates. Google map was included  where user can see his selected place.',
        'liveLink': 'https://travel-guru-3d05c.web.app/',
        'ghLink': 'https://github.com/syum-akhlaque/travel-guru',
    },
    {
        'title': 'Volunteer Network',
        'img': 'https://i.postimg.cc/V60S9P73/volunteer-network.jpg',
        'description': ' A full stack volunteer management website. Authenticated users can apply for social work as a volunteer. •	Users can see his volunteer task and cancel any task. Admin can add or delete events, modify the volunteer list.',
        'liveLink': 'https://volunteer-network-22.web.app/',
